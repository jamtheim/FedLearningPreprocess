...
# Remove the folder FinalAnon in conf.preProcess.outputNiftiPatientDir if it exists
...
# Remove the folder FinalAnonResampled in conf.preProcess.outputNiftiPatientDir if it exists
# This is done so we start with a clean plate every run
...
# Remove the folder FinalAnonResampledStacked in conf.preProcess.outputNiftiPatientDir if it exists
# This is done so we start with a clean plate every run
